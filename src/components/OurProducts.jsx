    ...
    <div className='p-5'>
      ...
      <div className='flex flex-wrap justify-center gap-10'>
        ...
        {products.map(product => (
          <div key={product.id} className="max-w-sm bg-white 
         dark:bg-gray-800 dark:border-gray-700">
            <a href="/home">
              <img className="rounded-t-lg transform transition-transform duration-300 hover:scale-105" src={product.image} alt={product.title} />
            </a>
            <div className="p-5">
              <a href="/home">
