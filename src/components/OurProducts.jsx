        ...
        {products.map(product => (
          <div key={product.id} className="max-w-sm bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              ...
              <a href="/home" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-amber-300 rounded-sm hover:bg-amber-200 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-amber-300 dark:hover:bg-amber-300 dark:focus:ring-amber-300 ">
                Veja Mais
